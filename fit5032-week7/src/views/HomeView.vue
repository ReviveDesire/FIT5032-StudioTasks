...
const validateReason = (blur) => {
  ...
  if (hasMessage) { greenMessage.value.reason = 'Great to have a friend'}
}
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-else-if="greenMessage.reason" class="text-safe">{{ greenMessage.reason }}</div>
          </div>
